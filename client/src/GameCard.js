        ...
        return (
            ...
            <div>
                <Card onMouseOver={this.handleHover} onMouseOut={this.handleHoverOut} id={"a"+this.props.games.id}>
                    <CardImg class="cardImage" onClick={this.toggle} top width="20%" src={this.props.games.background_image} alt="Card image cap" />
                        ...
                        <Modal isOpen={this.state.modal} toggle={this.toggle} className="modaltest">
                            ...
                            <ModalBody>
                                ...
                                <Row>
                                    ...
                                    <Col>
                                        <img src={this.props.games.background_image} width="100%" />
                                        <br />
